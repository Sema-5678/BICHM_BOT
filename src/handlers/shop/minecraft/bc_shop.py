...
minecraft_bc_shop_router = Router()
minecraft_bc_shop_router.callback_query(MinecraftShopCallback.filter(F.shop_type == "BC"))
...
@minecraft_bc_shop_router.callback_query(ShopCallback.filter(F.action == "show_categories"))
# @minecraft_bc_shop_router.callback_query(F.data == "minecraft_categories")
...
@minecraft_bc_shop_router.callback_query(ShopCallback.filter(F.action == "show_category_items"))
@protected_callback
...
@minecraft_bc_shop_router.callback_query(ShopCallback.filter(F.action == "show_item"))
@protected_callback
...
@minecraft_bc_shop_router.callback_query(ShopCallback.filter(F.action == "purchase_item"))
@protected_callback
...
# @minecraft_bc_shop_router.callback_query(ShopCallback.filter(F.action == "show_inventory"))
# @protected_callback
...
@minecraft_bc_shop_router.callback_query(ShopCallback.filter(F.action == "transfer_items"))
@protected_callback
...
@minecraft_bc_shop_router.message(ShopStates.awaiting_minecraft_username)
...
@minecraft_bc_shop_router.callback_query(F.data == "minecraft_inventory")
...
# @minecraft_bc_shop_router.callback_query(F.data == "minecraft_send_to_game")
...
# Handle back buttons
# @minecraft_bc_shop_router.callback_query(F.data == "shop")
